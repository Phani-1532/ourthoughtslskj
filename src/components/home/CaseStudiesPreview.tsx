...
const caseStudies = [
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/5234499/pexels-photo-5234499.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  },
];
  ...
  <SectionWrapper>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
      {caseStudies.map((cs, i) => (
        ...
        >
          <div className="gradient-border relative rounded-2xl border border-border hover:border-primary/30 h-full group hover:shadow-elevated transition-all duration-300 hover:-translate-y-1.5 bg-card overflow-hidden">
            {/* Image header */}
            <div className="relative h-36 overflow-hidden">
              <img src={cs.image} alt={cs.title} loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-card via-card/50 to-transparent" />
              <div className="absolute top-3 left-3 w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center backdrop-blur-sm border border-white/10 group-hover:bg-primary group-hover:shadow-glow transition-all duration-300">
            ...
            <div className="p-7 md:p-8 relative">
              <div className="absolute -top-20 -right-20 w-48 h-48 rounded-full bg-primary/0 group-hover:bg-primary/8 transition-colors duration-500 blur-2xl pointer-events-none" />
              ...
              <div className="relative">
                <span className="text-xs text-muted-foreground uppercase tracking-wider mb-3 block">{cs.client}</span>
