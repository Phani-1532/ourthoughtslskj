...
const faqs: Record<string, string> = {
  ...
  "demo": "You can book a free demo through our Contact page or click the 'Book Demo' button in the navbar!",
...
const findAnswer = (msg: string): string => {
  ...
  return "Thanks for your message! For detailed assistance, please reach out via our Contact page or email info@ourthoughtslskj.com. I can help with questions about our services, products, pricing, careers, and demos.";
};

export const ChatWidget = () => {
  const [open, setOpen] = useState(false);
  const [messages, setMessages] = useState<{ role: "bot" | "user"; text: string }[]>([
    { role: "bot", text: "Hi! 👋 I'm the Our Thoughts LSKJ assistant. Ask me about our services, products, or book a demo!" },
  ]);
      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-24 right-6 z-50 w-14 h-14 rounded-full bg-gradient-gold flex items-center justify-center shadow-gold hover:scale-110 transition-transform"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-80 sm:w-96 bg-card border border-border/50 rounded-2xl shadow-elevated overflow-hidden flex flex-col"
          ...
          >
            ...
            <div className="bg-gradient-gold p-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="font-display font-semibold text-primary-foreground">OT Assistant</span>
              </div>
            ...
            <div className="p-3 border-t border-border/30 flex gap-2">
              ...
              />
              <Button variant="hero" size="icon" onClick={send}><Send className="w-4 h-4" /></Button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
